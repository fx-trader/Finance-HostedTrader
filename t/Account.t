...
can_ok($acc, qw/refreshPositions getAsk getBid openMarket closeMarket getMinTradeSize getNav balance getBaseCurrency checkSignal getIndicatorValue waitForNextTrade convertBaseUnit getPosition getPositions closeTrades pl getServerEpoch getServerDateTime getSymbolBase/);

foreach my $method (qw/refreshPositions getBid getAsk getMinTradeSize getNav getBaseCurrency getServerEpoch getServerDateTime waitForNextTrade/) {
